...
$sql="update cars set Cimage4=:vimage where id=:id";
...
<head>
	...
	<title> Admin Update Image 4 - Agency CarRental </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Car Image 4 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default fm">
									<div class="panel-heading">Car Image 4 Details</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Current Image 4</label>
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Cimage4 from cars where cars.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<?php }}?>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
											<input type="file" name="img4" required style="
    margin-top: 11px;
">
												</div>
											</div>
