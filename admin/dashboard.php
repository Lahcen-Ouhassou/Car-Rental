...
<head>
	...
	<title> Admin Dashboard - Agency CarRental </title>
...
?>
											...
											<a href="reg-users.php" class="block-anchor panel-footer" style="
    text-align: center;
									...
									<div class="col-md-3">
										<div class="panel panel-default pdefault">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
$sql2 ="SELECT id from reservation ";
...
?>
											...
											<a href="manage-reservation.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default pdefault">
...
?>
											...
											<a href="manage-subscribers.php" class="block-anchor panel-footer" style="
    text-align: center;
">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default pdefault">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
$sql5 ="SELECT id from testimonial ";
