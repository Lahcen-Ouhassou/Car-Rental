...
<head>
	...
	<title> Admin Create Brand - Agency CarRental </title>
...
?>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control fm" value="<?php echo htmlentities($result->BrandName);?>" name="brand" id="brand" required>
												</div>
											</div>
										...
										<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-submit" name="submit" type="submit">Save Edit</button>
												</div>
											</div>
