...
<head>
	...
	<title>Admin Manage Queries - Agency CarRental    </title>
...
<body>
    ...
    <input type="text" id="searchInput" placeholder="Search Contact Queries ..."class="searchinput">
                ...
                if($query->rowCount() > 0) {
                    foreach($results as $result) { ?>
                        <tr  style="background-color: white;">
                            ...
                            <?php } else { ?>
                                <td>
                                    <a href="manage-contactus.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to read')" >Pending</a>
                                </td>
                            <?php } ?>
                        </tr>
                        <?php $cnt=$cnt+1; 
