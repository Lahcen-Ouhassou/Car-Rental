				...
				<div class="row">
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
															   <select name="menu1" onChange="MM_jumpMenu('parent',this,0)" style="
    margin-top: 10px;
    border-radius: 0px;
    height: 26px;
    width: 131px;
" required>
				  ...
				  <option value="manage-pages.php?type=FAQ">FAQ</option>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label" style="margin-top: -12px;">Selected Page</label>
												<div class="col-sm-8">
						<?php
...
?>
											...
											<div class="form-group">
												...
												<button type="submit" name="submit" value="Update" id="submit" class="btn-submit btn">Update</button>
												</div>
											</div>
